...
//        dd($res);
    ...
    public function success()
    {
        ...
        $res=DB::table('shop_order')->where($where)->first();
//        var_dump($res);die;
...
//            return redirect('car/success')->with('此订单无效');
        ...
        require_once app_path( 'aipay/wappay/service/AlipayTradeService.php' );
        require_once app_path( 'aipay/wappay/buildermodel/AlipayTradeWapPayContentBuilder.php' );
