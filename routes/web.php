...
Route::any('/comment','Goods\GoodsController@comment');
...
//所有商品
Route::get('/prolist.html','Goods\GoodsController@index');
//加入购物车
...
Route::get('/alipay{order_no}','Goods\GoodsController@alipay');
//购物车
