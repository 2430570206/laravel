     ...
     <div class="dingdanlist">
      <table>
            ...
            @foreach($addressInfo as $k=>$v)
              <tr>
                  @if($v->is_default==1)
                    <h3> <input type="radio" checked  name="is_default"  value="{{$v->address_id}}"> {{$v->address_name}}  {{$v->address_detail}}</h3>
       ...
       @endforeach
                ...
                <tr>
                    ...
                    <td align="right">
                        <textarea name="" id="order_text" cols="60" rows="10"></textarea>
        ...
        layui.use('layer',function(){
            ...
            $('.jiesuan').click(function(){
               ...
               var address_id=''
                ...
                $.post(
                    "submitform",
                    {goods_id:goods_id,pay_type:pay_type,address_id:address_id,order_text:order_text},
                    function(res){
                        if(res.code==1){
