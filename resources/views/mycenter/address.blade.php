...
<html lang="zh-cn">
  ...
  <body>
    <div class="maincont">
     ...
     <form  method="post" class="reg-login">
      <div class="lrBox">
       ...
       <div class="lrList"><input type="text" placeholder="详细地址" id="address_detail"/></div>
        ...
        <select class="area" id="city">
            <option  value="0" selected="selected" value="0">请选择</option>
        </select>
       ...
       <div class="lrList2"><input type="checkbox" id="is_default"  placeholder="设为默认地址" /> <button id="button">设为默认</button></div>
      </div><!--lrBox/-->
      <div class="lrSub">
